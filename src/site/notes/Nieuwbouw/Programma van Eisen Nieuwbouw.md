---
{"dg-publish":true,"permalink":"/nieuwbouw/programma-van-eisen-nieuwbouw/"}
---
...
- Ruimten op begane grond grotendeels rolstoelgeschikt:
	...
	- 1 hoofdslaapkamer
* Toegankelijk terras 
- Criteria: Handboek voor Toegankelijkheid, Integrale Toegankelijkheid Standaard (https://toegankelijkheidssymbool.nl). 

## Randvoorwaarden

### Bestemmingsplan, welstand, beeldkwaliteit etc:

Bestemming recreatiewoning (geen woonbestemming).
- Bouwvlak 100m2 
- Maximaal volume 300m2
- Maximaal 2 bouwlagen
- Geen platte daken
- Overstekken maximaal 0,75m

### Besluit Bouwwerken Leefomgeving (BBL)

- Vrijstelling op bruikbaarheidseisen nieuwbouw woonfunctie: recreatiewoning én particulier opdrachtgever.
	- Plafondhoogte 2400mm ipv 2700mm
	- Zolder niet officieel aangevraagd als verblijfsruimte
	- Trapbreedte 750mm ipv 900mm en minder lui
	- Deuren naar slaapkamers zolderverdieping 830mm ipv 930mm

- BENG-eisen wel aangehouden:
	- Houtskeletbouw; totale wanddikte ongeveer 300mm
	- Grondwarmtepomp
### Natura 2000
- Alleen bouwen toegestaan binnen bouwblok
- Stikstof